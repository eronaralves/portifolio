...
export function CardProject({ project }: ICardProject) {
  ...
  return (
    <div className="w-full flex flex-col-reverse md:flex-row flex-wrap md:flex-nowrap gap-8">
      ...
      <a href={project.url_site} target="_blank" className="max-w-lg md:min-w-[400px] h-52 md:h-72 flex justify-center rounded-lg transform transition-transform duration-300 hover:scale-105">
      ...
      <div className="w-full max-w-[514px] flex flex-col justify-between gap-5 md:gap-2">
        <div className="h-full flex flex-col justify-center">
          ...
          <p className="max-h-full text-gray-secondary mt-5 line-clamp-6 overflow-y-scroll">{project.description}</p>
        </div>
